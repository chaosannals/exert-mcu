# OLED 屏幕
# 3.3V
# 代码来源 https://github.com/AnthonyKNorman/MicroPython_SSD1306
...
class SSD1306(object):
    ...
    def __init__(self, i2c, height=64, external_vcc=True, i2c_devid=DEVID):
...
d = SSD1306(I2C(0, scl=Pin(18), sda=Pin(19), freq=400000))
d.poweron()
d.init_display()
d.clear()
d.display()
